    ...
    ?>
        ...
        <div class="row">
            ...
            <?php
                ...
                //menghitung jumlah bagian pegawai
                $count5 = mysqli_num_rows(mysqli_query($config, "SELECT * FROM tbl_bag_pegawai"));
        ...
        <?php
            ...
            <div class="col s12 m4">
                <div class="card green">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">people</i> Jumlah Bagian Pegawai</span>
                        <?php echo '<h5 class="white-text link">'.$count5.' Bagian Pegawai</h5>'; ?>
                    </div>
                </div>
            </div>
        <?php

...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"> SIMAS PAKEM</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Kecamatan Pakem Yogyakarta</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan Raya Cangkringan-Pakem No. 3 Kabupaten Sleman Provinsi D.I. Yogyakarta</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <?php
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">settings</i> Master Data</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=sett">Instansi</a></li>
                                <li><a href="?page=sett&sub=bagpeg">Bagian Pegawai</a></li>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"> SIMAS PAKEM</a></li>
            <li><div class="grs"></></li>
            ...
            <?php
                if($_SESSION['admin'] == 1){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="pengaturan">Master Data <i class="material-icons md-18">arrow_drop_down</i></a></li>

            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        ...
                        echo 'Kecamatan Pakem Yogyakarta  &nbsp;|&nbsp; <a class="white-text" href="http://www.pakemkec.slemankab.go.id" target="_blank">By Rudiono</a>';
                    }
                ?>
            </a>
            </span>
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> www.pakemkec.slemankab.go.id &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  pakemkec@slemankab.go.id';
                    }
                }
                ?>
            </div>

        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    echo '<h5 class="up">PEMERINTAH KABUPATEN SLEMAN</h5>';
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama">Kecamatan Pakem</h5><br/>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat">Jalan Raya Cangkringan No.3 Pakem, Sleman, Yogyakarta</span>';
                    }
                    echo '
                </div>
                <br/>
                        ...
                        <tbody>
                            ...
                            <tr class="isi">';
                                ...
                                <td colspan="2">
                                    ...
                                    <strong>Tanggal Penyelesaian</strong> : '.$d." ".$nm." ".$y.'<br/>
            ...
            <div id="lead">
                ...
                if(!empty($camat)){
                    ...
                    echo '<p class="lead">Suyanto, S.Sos.,MM.</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP '.$nip.'</p>';
                } else {

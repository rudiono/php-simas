        ...
        if($_SESSION['admin'] != 1){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['nama'] == "" ||$_REQUEST['alamat'] == "" || $_REQUEST['camat'] == "" || $_REQUEST['nip'] == ""
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                ...
                                if(!preg_match("/^[a-zA-Z., ]*$/", $camat)){
                                    ...
                                    if(!preg_match("/^[0-9 -]*$/", $nip)){
                                        $_SESSION['nipcamat'] = 'Form NIP Camat hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                        echo '<script language="javascript">window.history.back();</script>';
                                    } else {
                                                ...
                                                if(!empty($logo)){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2000000){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',alamat='$alamat',camat='$camat',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                    ...
                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',alamat='$alamat',camat='$camat',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="camat" type="text" class="validate" name="camat" value="<?php echo $row['camat']; ?>" required>
                                            <?php
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika  belum memiliki NIP, isi dengan minus(-)">
                                        ...
                                        <input id="nip" type="text" class="validate" name="nip" value="<?php echo $row['nip']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['nipcamat'])){
                                                    $nipcamat = $_SESSION['nipcamat'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nipcamat.'</div>';
                                                    unset($_SESSION['nipcamat']);
                                                }
                                            ?>
                                        <label for="nip">NIP Camat</label>
                                    </div>
                                    <div class="input-field col s6">

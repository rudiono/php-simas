                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            <div class="disp hidd">';
                                ...
                                echo '<h5 class="up">PEMERINTAH KABUPATEN SLEMAN</h5><br/>';
                                if(!empty($nama)){
                                    echo '<h5 class="up" id="nama">'.$nama.'</h5>';
                                } else {
                                    echo '<h5 class="up" id="nama">Kecamatan Pakem</h5>';
                                }
                                echo "<br/>";
                                echo "<br/>";
                                echo "<br/>";
                                ...
                                if(!empty($alamat)){
                                    ...
                                    echo '<span id="alamat">Jalan Raya Cangkringan No.3 Pakem, Sleman, Yogyakarta</span><br/>';
                                }
                                echo '
                            </div>

...
<head>
    ...
    <title>Sistem Informasi Manajemen Arsip Surat Kecamatan Pakem</title>
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title"><strong>SIMAS LOGIN</strong></strong></h5>
                            <?php
                                if(!empty($data['logo'])){
                            ...
                            ?>
                            <h5 class="center" id="nama">
                            <?php
                                if(!empty($data['nama'])){
                                    echo ''.$data['nama'].'';
                                } else {
                                    echo 'Kecamatan Pakem';
                                }
                             ?>
                            </h5>
                            <div class="batas"></div>
